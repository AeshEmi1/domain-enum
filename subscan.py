...
with open(output_file, "w") as f:
    ...
    amass_command = ["amass", "enum", "-brute", "-df",  args.input_file, "-o", amass_file]
    amass_command_verbose = ["amass", "enum", "-brute", "-df",  args.input_file, "-o", amass_file, "-v"]
    if args.verbose:
        result = subprocess.run(amass_command_verbose)
    else:
    ...
    if args.verbose:
        result = subprocess.run(subfinder_command_verbose)
    else:
